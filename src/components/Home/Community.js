      ...
      <div id="community">
        ...
        <div className="community-container">
          ...
          <div
            className={
              tab === 1
                ? "writeCommunity community-content active"
                : "writeCommunity community-content"
            }
          >
            <div className="write-category">
              ...
              <form className="write-area" action="">
                ...
                <label id="upload-image-label">이미지 업로드</label>
        ...
        {/* 둘러보기 */}
          ...
          <div
            className={
              tab === 2
                ? "ReadCommunity community-content active"
                : "ReadCommunity community-content"
            }
          >
